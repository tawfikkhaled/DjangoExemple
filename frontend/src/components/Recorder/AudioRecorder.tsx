...
export default class AudioRecorder extends Component<IPropsModel, IStateModel> {
  constructor(props) {
    super(props);
  }
  ...
  handleChange = (e) => {
    ...
    const record = document.querySelector('.record') as any;
    const stop = document.querySelector('.stop') as any;
    const soundClips = document.querySelector('.sound-clips') as any;
    const canvas = document.querySelector('.visualizer') as any;
    const mainSection = document.querySelector('.main-controls') as any;
      ...
      let onSuccess = function (stream) {
        ...
        mediaRecorder.onstop = function (e) {
          ...
          downloadButton.onclick = function (e) {
            downloadBlob(blob, clipLabel.textContent);
          }
        }
  ...
  render() {
    ...
    return (
      <div onLoad={this.handleChange}>
        ...
        <Button onClick={this.handleChange}> init </Button>
